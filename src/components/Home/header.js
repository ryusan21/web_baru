...
import hero from "../../images/logo-alfit.png"

const Header = () => {
  return (
    <Fade duration={2200}>
      <div className="max-w-8xl mx-auto lg:px-6 md:px-3">
        <div className="my-10 h-[360px] mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-0 flex gap-10 lg:flex-justify lg:flex     flex-col lg:flex-row flex-col-reverse">
          <div className="text-center lg:text-left flex flex-col justify-center">
            <h1 className="text-black text-3xl font-semibold opacity-70">
              Selamat Datang Di Sekolah
            </h1>
            <h2 className="text-black text-gradient bg-gradient-to-r from-pink to-purple text-6xl font-bold xxs:text-2xl xs:text-3xl sm:text-3xl lg:text-6xl">
              AL-FITYAN
            </h2>
{/* 
          ...
          <div className="xl:ml-32 lg:inset-y-0 lg:right-0 lg:w-1/2 my-4 flex lg:justify-end justify-center">
            <img
